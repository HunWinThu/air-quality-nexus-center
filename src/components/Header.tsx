      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-3">
          ...
          <Link to="/" className="flex items-center space-x-3">
            <img src={logo} alt="Air Quality Nexus" className="h-16 w-28 md:h-16 md:w-34" />
                ...
                return (
                  <div key={item.name} className="relative group">
                    ...
                    <div className="absolute top-full left-0 mt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 ease-out transform translate-y-[-10px] group-hover:translate-y-0 z-50">
                      <div className="min-w-[200px] rounded-xl border border-border bg-transparent backdrop-blur-md shadow-lg p-2 animate-fade-in">
                        <Link 
                          to="/launching-event" 
